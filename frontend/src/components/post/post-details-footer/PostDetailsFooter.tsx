...
import { CommentIcon, LikedIcon, LikeIcon, MenuDotsIcon, RepostIcon } from "../../../icons";
...
const PostDetailsFooter: React.FC<PostDetailsFooterProps> = ({hasLiked, type, postId, currentUserId, postUsername}) => {
  ...
  return (
    <div className="post-details-footer">
      ...
      <div className="icon">
        <RepostIcon size={20} color="#737d8f" />
        Repost
      </div>
